        ...
        <div className='rounded-3xl px-10 bg-gradient-to-b from-[#FFFFFF] to-[#F4F9FF] py-20'>
            <div className="container mx-auto text-center">
                ...
                <div className="flex align-middle justify-center gap-8">
                    <div className='text-center relative px-4 flex flex-col justify-center align-middle '>
                    ...
                    <div className='text-center relative px-4 flex flex-col justify-center items-center'>
                        <div className='relative'>
